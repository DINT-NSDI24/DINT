...
#define VAL_SIZE 8
#define ACCOUNT_NUM 24000000
#define KEYS_PER_ENTRY 4
#define MAX_LOG_ENTRY_NUM 1000000

#define SAV_HASH_SIZE (ACCOUNT_NUM*3/2/KEYS_PER_ENTRY)
#define CHK_HASH_SIZE (ACCOUNT_NUM*3/2/KEYS_PER_ENTRY)
...
#define ACQUIRE_SHARED 0
#define ACQUIRE_EXCLUSIVE 1
#define RELEASE_SHARED 2
#define RELEASE_EXCLUSIVE 3
#define COMMIT_PRIM 4
#define COMMIT_BCK 5
#define COMMIT_LOG 6

#define GRANT_SHARED 7
#define REJECT_SHARED 8
#define GRANT_EXCLUSIVE 9
#define REJECT_EXCLUSIVE 10
#define RELEASE_SHARED_ACK 11
#define RELEASE_EXCLUSIVE_ACK 12
#define COMMIT_PRIM_ACK 13
#define COMMIT_BCK_ACK 14
#define COMMIT_LOG_ACK 15
#define RETRY 16
#define WARMUP_READ 17
#define WARMUP_READ_ACK 18
